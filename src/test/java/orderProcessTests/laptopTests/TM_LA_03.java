...
public class TM_LA_03 extends Hooks {
	...
	void testLaptopsOrderingMultiple() {
		...
		// 4-) Verify that button in MacBook Pro card is turned to "Added to Cart".
			ExtentReportListener.getTest().info(" 4-) Verify that button in MacBook Pro card is turned to \"Added to Cart\".");
		...
		// the popup.
			ExtentReportListener.getTest().info(" 6-) Verify that Samsung Galaxy Book and HP Pavilion 15-DK1056WM are visible on\n" +
					"\t\t// the popup.");
			wait(2);
