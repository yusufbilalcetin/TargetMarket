...
public class TM_LA_03 extends Hooks {
	...
	void testLaptopsOrderingMultiple() {
		try {
			...
			// 3-) Add Samsung Galaxy Book and HP Pavilion 15-DK1056WM to cart.
			ExtentReportListener.getTest().info("3-) Add Samsung Galaxy Book and HP Pavilion 15-DK1056WM to cart.");
			...
			// 6-) Verify that Samsung Galaxy Book and HP Pavilion 15-DK1056WM are visible
			// on
			// the popup.
			ExtentReportListener.getTest()
				.info(" 6-) Verify that Samsung Galaxy Book and HP Pavilion 15-DK1056WM are visible on\n"
						+ "\t\t// the popup.");
			wait(2);
			...
			softAssert.assertTrue(
					homePage.getPerProductPriceOnTheCart(2)
						.contains(homePage.getProductPrice("HP Pavilion 15-DK1056WM")),
					"Product price is different on the cart");

			// 8-) Click on "+" button twice to increase the amount of the first item to
			// 3.
			ExtentReportListener.getTest()
				.info(" 8-) Click on \"+\" button twice to increase the amount of the first item to 3.");
			wait(2);
			...
			// correct.
			ExtentReportListener.getTest()
				.info(" 9-) Verify that the first product's amount is \"3\" and the total price is\n"
						+ "\t\t// correct.");
			wait(2);
			...
			// correct.
			ExtentReportListener.getTest()
				.info("10-) Verify that the second product's amount is \"4\" and the total price is\n"
						+ "\t\t// correct.");
