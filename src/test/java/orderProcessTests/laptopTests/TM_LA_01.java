...
public class TM_LA_01 extends Hooks {
    ...
    void testLaptops() {
        ...
        // 4-) Verify that button in MacBook Pro card is turned to "Added to Cart".
        softAssert.assertEquals(homePage.getButtonText("MacBook Pro"),
                "Added to Cart",
        ...
        softAssert.assertEquals(homePage.getProductNameOnTheCart(1),
                "MacBook Pro", "Product is not added to the cart"); ;

        // 7-) Verify that the price is the same on the popup.
        softAssert.assertTrue(homePage.getPerProductPriceOnTheCart(1)
                        .contains(homePage.getProductPrice("MacBook Pro")),
        ...
        wait(2);
        softAssert.assertEquals(homePage.getProductNumberOnTheCart(1),
                "3", "Increase product amount button on the cart doesn't work");
