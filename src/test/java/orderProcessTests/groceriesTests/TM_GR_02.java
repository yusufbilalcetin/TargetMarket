...
public class TM_GR_02 extends Hooks {
	...
	void testGroceries() {
		try {
			...
			// 7-) Verify that Orange Essence Food Flavou is visible on the popup.
			ExtentReportListener.getTest()
				.info("  7-) Verify that Orange Essence Food Flavou is visible on the popup.");
			...
			// 12-)Verify that button in Orange Essence Food Flavou card is turned to "Add
			// to
			// Cart".
			ExtentReportListener.getTest()
				.info(" // 12-)Verify that button in Orange Essence Food Flavou card is turned to \"Add to\n"
						+ "            // Cart\".");
