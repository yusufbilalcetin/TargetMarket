...
public class TM_HD_03 extends Hooks {
	...
	void testHomeDecorations() {
		try {
			...
			// 3-) Add Flying Wooden Bird and 3D Embellishment Art Lamp to cart.
			ExtentReportListener.getTest().info(" 3-) Add Flying Wooden Bird and 3D Embellishment Art Lamp to cart.");
			...
			ExtentReportListener.getTest()
				.info("4-) Verify that buttons Flying Wooden Bird and 3D Embellishment Art Lamp\n"
						+ "\t\t// cards are turned to \"Added to Cart\".");
			...
			ExtentReportListener.getTest()
				.info("6-) Verify that Flying Wooden Bird and 3D Embellishment Art Lamp are\n"
						+ "\t\t// visible on the popup.");
			...
			softAssert.assertTrue(
					homePage.getPerProductPriceOnTheCart(2)
						.contains(homePage.getProductPrice("3D Embellishment Art Lamp")),
					"Product price is different on the cart");
