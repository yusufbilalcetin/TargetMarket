...
public class TM_TO_02 extends Hooks {
	...
	void testTops() {
		try {
			...
			ExtentReportListener.getTest().info("2-) Click on Tops category.");
			homePage.clickOnCategory(8);

			// 3-) Add ank Tops for Womens/Girls to cart.
			ExtentReportListener.getTest().info("3-) Add ank Tops for Womens/Girls to cart.");
			homePage.addToCart("ank Tops for Womens/Girls");

			// 4-) Verify that button in ank Tops for Womens/Girls is turned to "Added to
			// Cart".
			ExtentReportListener.getTest()
				.info("4-) Verify that button in ank Tops for Womens/Girls is turned to \"Added to Cart\".");
			...
			ExtentReportListener.getTest().info("7-) Verify that ank Tops for Womens/Girls is visible on the popup.");
			...
			softAssert.assertTrue(
					homePage.getPerProductPriceOnTheCart(1)
						.contains(homePage.getProductPrice("ank Tops for Womens/Girls")),
			...
			// 12-)Verify that button in ank Tops for Womens/Girls card is turned to "Add
			// to Cart".
			ExtentReportListener.getTest()
