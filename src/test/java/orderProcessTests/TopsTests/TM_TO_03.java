...
public class TM_TO_03 extends Hooks {
	...
	void testTops() {
		try {
			...
			ExtentReportListener.getTest().info("3-) Add Sleeve Shirt Womens and cereals muesli fruit nuts to cart.");
			homePage.addToCart("Sleeve Shirt Womens");
			homePage.addToCart("ank Tops for Womens/Girls");

			// 4-) Verify that buttons Orange Essence Food Flavou and cereals muesli fruit
			// nuts cards are turned to "Added to Cart".
			ExtentReportListener.getTest()
				.info("4-) Verify that buttons Orange Essence Food Flavou and cereals muesli fruit nuts cards are turned to \"Added to Cart\".");
			...
			ExtentReportListener.getTest()
				.info("6-) Verify that Sleeve Shirt Womens and ank Tops for Womens/Girls are visible on the popup.");
